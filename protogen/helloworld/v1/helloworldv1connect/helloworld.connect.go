...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/spgyip/grpc-gateway-json-transcoding/protogen/helloworld/v1"
	http "net/http"
	strings "strings"
)
...
var (
	greeterServiceServiceDescriptor        = v1.File_helloworld_v1_helloworld_proto.Services().ByName("GreeterService")
