...
type HelloRequest struct {
	...
	Sub  *HelloRequest_SubMessage `protobuf:"bytes,2,opt,name=sub,proto3" json:"sub,omitempty"`
}
...
func (x *HelloRequest) GetSub() *HelloRequest_SubMessage {
	if x != nil {
		return x.Sub
	}
	return nil
...
type HelloRequest_SubMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HelloRequest_SubMessage) Reset() {
	*x = HelloRequest_SubMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *HelloRequest_SubMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloRequest_SubMessage) ProtoMessage() {}

func (x *HelloRequest_SubMessage) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_helloworld_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloRequest_SubMessage.ProtoReflect.Descriptor instead.
func (*HelloRequest_SubMessage) Descriptor() ([]byte, []int) {
	return file_helloworld_helloworld_proto_rawDescGZIP(), []int{0, 0}
}

func (x *HelloRequest_SubMessage) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *HelloRequest_SubMessage) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x35, 0x0a, 0x03,
	0x73, 0x75, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	...
	0x73, 0x75, 0x62, 0x1a, 0x30, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x74, 0x65, 0x78, 0x74, 0x22, 0x26, 0x0a, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
...
var file_helloworld_helloworld_proto_goTypes = []interface{}{
	...
	(*HelloRequest_SubMessage)(nil), // 2: helloworld.HelloRequest.SubMessage
}
var file_helloworld_helloworld_proto_depIdxs = []int32{
	2, // 0: helloworld.HelloRequest.sub:type_name -> helloworld.HelloRequest.SubMessage
...
func file_helloworld_helloworld_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_helloworld_helloworld_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloRequest_SubMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
